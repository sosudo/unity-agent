...
@click.command()
@click.option("--source", "source", default="source.tex", type=click.Path(exists=True, dir_okay=True, readable=True), help="Source material to autoformalize (file or directory) [`source.tex` default]")
@click.option("--project", "PROJECT_DIR", default=".", type=click.Path(exists=False, dir_okay=True, readable=True), help="Target project directory (requires autofix) [`unity_project/` default]")
@click.option("--context", "context", is_flag=True, default=False, help="Are there already Lean files in the project? (requires autofix, project)")
async def main(source, PROJECT_DIR, context):
    ...
    try:
        ...
        # Set environment
        save_spec = os.getenv("SAVE_SPECIFICATION")
        no_bypass = os.getenv("NO_BYPASS")
        generation_budget = os.getenv("GENERATION_BUDGET")
        semiformalization_budget = os.getenv("SEMIFORMALIZATION_BUDGET")
        exploration_budget = os.getenv("EXPLORATION_BUDGET")
        preparation_budget = os.getenv("PREPARATION_BUDGET")
        formalization_budget = os.getenv("FORMALIZATION_BUDGET")
        critic_budget = os.getenv("CRITIC_BUDGET")
        save_semiformalization = os.getenv("SAVE_SEMIFORMALIZATION")
        autofix = os.getenv("AUTOFIX")
        exploration = os.getenv("EXPLORATION")
        recurse = os.getenv("RECURSE")
    ...
    try:
        ...
        with open("PROMPTS/GENERATION.md", "r") as f:
            GENERATION_PROMPT = f.read()
        with open("SUBAGENTS/GENERATION/GENERATOR.md", "r") as f:
    ...
    if not autofix and not context:
        try:
            ...
            with open("PROMPTS/SEMIFORMALIZATION/FF.md", "r") as f:
                SEMIFORMALIZATION_PROMPT = f.read()
            with open("SUBAGENTS/SEMIFORMALIZATION/FF.md", "r") as f:
        ...
        try:
            # Load semiformalization phase system prompt and semiformalizer subagent prompt
            with open("PROMPTS/SEMIFORMALIZATION/TF.md", "r") as f:
                SEMIFORMALIZATION_PROMPT = f.read()
            with open("SUBAGENTS/SEMIFORMALIZATION/TF.md", "r") as f:
                SEMIFORMALIZER_SUBAGENT = f.read()
        ...
        try:
            # Load semiformalization phase system prompt and semiformalizer subagent prompt
            with open("PROMPTS/SEMIFORMALIZATION/TT.md", "r") as f:
                SEMIFORMALIZATION_PROMPT = f.read()
            with open("SUBAGENTS/SEMIFORMALIZATION/TT.md", "r") as f:
                SEMIFORMALIZER_SUBAGENT = f.read()
    ...
    if exploration:
        ...
        if not recurse and not context:
            try:
                ...
                with open("PROMPTS/EXPLORATION/FF.md", "r") as f:
                    EXPLORATION_PROMPT = f.read()
                with open("SUBAGENTS/EXPLORATION/EXPLORER/F.md", "r") as f:
                    EXPLORER_SUBAGENT = f.read()
                with open("SUBAGENTS/EXPLORATION/SEMIFORMALIZER/F.md", "r") as f:
                    SEMIFORMALIZER_SUBAGENT = f.read()
                with open("SUBAGENTS/EXPLORATION/EXPLORATIONGENERATOR.md", "r") as f:
            ...
            try:
                # Load exploration phase system prompt and explorer, semiformalizer, and exploration-generator subagent prompts
                with open("PROMPTS/EXPLORATION/FT.md", "r") as f:
                    EXPLORATION_PROMPT = f.read()
                with open("SUBAGENTS/EXPLORATION/EXPLORER/T.md", "r") as f:
                    EXPLORER_SUBAGENT = f.read()
                with open("SUBAGENTS/EXPLORATION/SEMIFORMALIZER/T.md", "r") as f:
                    SEMIFORMALIZER_SUBAGENT = f.read()
                with open("SUBAGENTS/EXPLORATION/EXPLORATIONGENERATOR.md", "r") as f:
                    EXPLORATIONGENERATOR_SUBAGENT = f.read()
            ...
            try:
                # Load exploration phase system prompt and explorer, semiformalizer, and exploration-generator subagent prompts
                with open("PROMPTS/EXPLORATION/TF.md", "r") as f:
                    EXPLORATION_PROMPT = f.read()
                with open("SUBAGENTS/EXPLORATION/EXPLORER/F.md", "r") as f:
                    EXPLORER_SUBAGENT = f.read()
                with open("SUBAGENTS/EXPLORATION/SEMIFORMALIZER/F.md", "r") as f:
            ...
            try:
                # Load exploration phase system prompt and explorer, semiformalizer, and exploration-generator subagent prompts
                with open("PROMPTS/EXPLORATION/TT.md", "r") as f:
                    EXPLORATION_PROMPT = f.read()
                with open("SUBAGENTS/EXPLORATION/EXPLORER/T.md", "r") as f:
                    EXPLORER_SUBAGENT = f.read()
                with open("SUBAGENTS/EXPLORATION/SEMIFORMALIZER/T.md", "r") as f:
    ...
    if not context:
        try:
            ...
            with open("PROMPTS/PREPARATION/F.md", "r") as f:
        ...
        try:
            # Load preparation phase system prompt
            with open("PROMPTS/PREPARATION/T.md", "r") as f:
                PREPARATION_PROMPT = f.read()
    ...
    if not context:
        try:
            ...
            with open("PROMPTS/FORMALIZATION/F.md", "r") as f:
                FORMALIZATION_PROMPT = f.read()
            with open("SUBAGENTS/FORMALIZATION/DECLARATIONFORMALIZER/F.md", "r") as f:
                DECLARATIONFORMALIZER_SUBAGENT = f.read()
            with open("SUBAGENTS/FORMALIZATION/PROOFFORMALIZER/F.md", "r") as f:
        ...
        try:
            # Load formalization phase system prompt and declaration-formalizer and proof-formalizer subagent prompts
            with open("PROMPTS/FORMALIZATION/T.md", "r") as f:
                FORMALIZATION_PROMPT = f.read()
            with open("SUBAGENTS/FORMALIZATION/DECLARATIONFORMALIZER/T.md", "r") as f:
                DECLARATIONFORMALIZER_SUBAGENT = f.read()
            with open("SUBAGENTS/FORMALIZATION/PROOFFORMALIZER/T.md", "r") as f:
                PROOFFORMALIZER_SUBAGENT = f.read()
    ...
    if not context:
        try:
            ...
            with open("SUBAGENTS/CRITIC/DECLARATIONFORMALIZER/F.md", "r") as f:
                DECLARATIONFORMALIZER_SUBAGENT = f.read()
            with open("SUBAGENTS/CRITIC/PROOFFORMALIZER/F.md", "r") as f:
                PROOFFORMALIZER_SUBAGENT = f.read()
        ...
        try:
            ...
            with open("PROMPTS/CRITIC.md", "r") as f:
                CRITIC_PROMPT = f.read()
            with open("SUBAGENTS/CRITIC/DECLARATIONFORMALIZER/T.md", "r") as f:
                DECLARATIONFORMALIZER_SUBAGENT = f.read()
            with open("SUBAGENTS/CRITIC/PROOFFORMALIZER/T.md", "r") as f:
                PROOFFORMALIZER_SUBAGENT = f.read()
